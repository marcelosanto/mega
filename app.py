...
class LoteriaApp:
    ...
    def salvar_jogo_atual(self):
        ...
        # Criar janela para adicionar observações
...
🎯 NÚMEROS JOGADOS:"""
    ...
    def carregar_dados(self):
        ...
        try:
            df = pd.read_excel(config['caminho_xlsx'],
                               sheet_name=0, skiprows=6)
    ...
    def atualizar_dezenas(self, *args):
        ...
        if hasattr(self, 'dezenas_scale'):
            self.dezenas_scale.config(
                from_=config['min_dezenas'],
                to=config['max_dezenas'])

        # Atualizar label das dezenas
        if hasattr(self, 'dezenas_value_label'):
            self.atualizar_label_dezenas()

        # Atualizar informações da loteria
...
• Lembre-se: loteria é totalmente aleatória!"""
    ...
    def criar_bola_canvas(self, parent, numero, cor_base, tamanho=35):
        """Criar uma bola mais estilizada"""
    ...
    def gerar_jogos(self):
        # Limpar canvas e resultados anteriores
        ...
        # Armazenar jogos atuais para poder salvar
        ...
        # Exibir números com bolas estilizadas
        for idx, nums in enumerate(jogos, 1):
            ...
            # Adicionar ao resultado em texto também
    ...
    def mostrar_grafico(self):
        ...
        # Destacar os números mais frequentes
    ...
    def criar_interface(self):
        ...
        # Coluna direita - Informações e resultados
        ...
        # Frame com scroll para os números
        ...
        scrollbar = ttk.Scrollbar(
            canvas_container, orient="vertical", command=canvas_scroll.yview)
        self.canvas_frame = tk.Frame(canvas_scroll, bg='#45475a')
    ...
    def __del__(self):
        """Fechar conexão com banco de dados ao destruir objeto"""
